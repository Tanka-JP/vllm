...
if TYPE_CHECKING:
    ...
    VLLM_BATCH_INVARIANT_LINEAR: bool = True
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Diagnostic opt-out for the persistent unquantized-linear kernel while
    # retaining the other batch-invariant runtime paths.
    "VLLM_BATCH_INVARIANT_LINEAR": lambda: bool(
        int(os.getenv("VLLM_BATCH_INVARIANT_LINEAR", "1"))
    ),
